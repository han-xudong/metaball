...
This script exports a trained BallNet model to the .safetensors format.
...
def safetensors_export(ckpt_path: str) -> None:
    ...
    model = BallNet.load_from_checkpoint(ckpt_full_path, map_location=device)
    model.eval()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="lightning_logs/ballnet/",
